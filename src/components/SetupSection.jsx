            ...
            <div className="grid md:grid-cols-2 gap-6 items-start">
                ...
                <div className="mt-6 pt-6 border-t border-gray-700">
                        ...
                        <div>
                            <label 
                                ...
                                className={`w-full flex items-center justify-center bg-gray-700 border-2 border-dashed border-purple-500/30 rounded-lg px-4 py-3 text-gray-300 transition-all duration-200 ${
                                    isParsingKiCad ? 'cursor-not-allowed opacity-50' : 'cursor-pointer hover:bg-gray-600 hover:border-purple-500'
                                }`}
                            >
                                {isParsingKiCad ? (
                                    <>
                    ...
                    <div className="mt-4 text-xs text-gray-500">
                        <p>💡 <strong>Tip:</strong> Upload your KiCad schematic to enable the "Copy for KiCad" button for each component.</p>
                    </div>
                </div>
            </div>
